...
<div class="container mt-3">
   <form method="post" action="/auth/securityLogin">
     ...
     <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=c97da230f6c4908dd2fed75aa2b55020&redirect_uri=http://localhost:8888/oauth/kakao">
